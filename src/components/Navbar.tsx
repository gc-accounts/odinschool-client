...
import { Menu, X, Calculator, FileText, Book, Download, BookOpen, MapPin, Briefcase, Video } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Virtual Interview', path: '/virtual-interview', icon: <Video className="h-4 w-4 mr-1" /> },
    { name: 'Careers', path: '/careers', icon: <Briefcase className="h-4 w-4 mr-1" /> },
