      ...
      <div className='grid md:grid-cols-12'>
        <div className='md:col-span-5'>
          <div className="mb-4 flex items-center gap-2 bg-primary-100 px-3 py-1 rounded-full inline-block w-fit">
           ...
           <h2 className="text-3xl md:text-5xl font-display leading-tight md:my-8 my-4">Data Science Course <span className='text-primary-600 block mt-3'></span></h2>

           <ul className=' delay-100 grid grid-cols-2 gap-4 mb-6'>
                        <li className='flex gap-1 px-2 py-3 rounded-md border border-primary-600 bg-primary-100'><span className='mr-2 flex items-center'><CiCircleCheck className='md:w-5 md:h-5 w-5 h-5 rounded-full bg-primary-600 text-white' /></span> <span className='md:text-md text-sm'>Live instructor-led Classes </span></li>
                        <li className='flex gap-1 px-2 py-3 rounded-md border border-primary-600 bg-primary-100'><span className='mr-2 flex items-center'><CiCircleCheck className='md:w-5 md:h-5 w-5 h-5 rounded-full bg-primary-600 text-white' /></span> <span className='md:text-md text-sm'>Job Application Portal </span></li>
                        <li className='flex gap-1 px-2 py-3 rounded-md border border-primary-600 bg-primary-100'><span className='mr-2 flex items-center'><CiCircleCheck className='md:w-5 md:h-5 w-5 h-5 rounded-full bg-primary-600 text-white' /></span> <span className='md:text-md text-sm'>Project-based Learning</span></li>
                        <li className='flex gap-1 px-2 py-3 rounded-md border border-primary-600 bg-primary-100'><span className='mr-2 flex items-center'><CiCircleCheck className='md:w-5 md:h-5 w-5 h-5 rounded-full bg-primary-600 text-white' /></span> <span className='md:text-md text-sm'>Industry Interaction  </span></li>
                      </ul>
