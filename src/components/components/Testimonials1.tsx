      ...
      <div className="container mx-auto">
        <div ref={headerRef} className="text-center max-w-4xl mx-auto mb-10 opacity-0">
          <h2 className="text-3xl font-bold mb-2">
            Data Science <span className="text-primary-600">Career Transitions!</span>
          </h2>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div ref={testimonialsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-0 mt-8">
