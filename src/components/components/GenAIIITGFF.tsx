      ...
      <div className='grid md:grid-cols-12'>
        <div className='md:col-span-6'>
          <Image src='https://strapi.odinschool.com/uploads/eictlogo_a3cb0918ad.png' className='mb-3' alt='eictlogo' width={200} height={100} />
           <h2 className="text-3xl md:text-5xl font-display leading-tight">Certification Program in <span className='text-primary-600 block mt-3'>Applied Generative AI</span></h2>
