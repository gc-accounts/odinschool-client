  ...
  return (
    <div className={parentClass}>
...

      {
        isBrochureButton &&
        <Button
          className='bg-transparent border border-black hover:border-black rounded-sm text-black md:text-lg text-sm md:px-4 px-2 md:py-3 py-1 hover:bg-white hover:text-black outline-none focus:outline-none'
