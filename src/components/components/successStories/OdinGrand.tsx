...
import { odinGradNow, odinGradOfTheMonth, odinGradsSuccessStories, arr } from "@/components/data/success-stories-data/alumniMeetNGreet";
            ...
            <div className="flex items-center gap-2">
              {dots.map((index) => (
                <button
                  ...
                  className={`h-[0.4rem] w-[0.4rem]  rounded-full transition-all duration-300 md:h-2 md:w-2 ${index === selectedIndex
