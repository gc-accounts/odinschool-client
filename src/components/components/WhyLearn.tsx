    ...
    <section className={`${sectionClass ? sectionClass : ' pb-[50px] md:pb-[70px] bg-white'} overflow-hidden relative`}>
      ...
      <div className='grid md:grid-cols-12'>
        <div className='md:col-span-6'>
           <h2 className="text-3xl md:text-4xl md:leading-[1.2] leading-[1.3] mb-2">Why learn <span className='text-primary-600'>Generative AI</span>  now?</h2>
           <p className='text-md mb-3'>Because Generative AI is the Future.</p>
           <p className='text-md mb-3'>One of the most cutting-edge innovations of recent times, Generative AI is projected to become a $1.3 trillion market in the next 8 years, with a compound annual growth rate of almost 27%.</p>
           <p className='text-md mb-3'>Professionals skilled in Generative AI will have a lot of career growth opportunities in various industry domains. A recent global survey revealed that 57% of IT companies have identified their Generative AI use cases, out of which 41% are actively upskilling their employees to meet their demands!</p>
