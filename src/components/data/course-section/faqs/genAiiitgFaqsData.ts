export const genAiiitgFaqsData = [
  {
    "id": 1,
  ...
  },
  {
    ...
    "answer": "Exclusively for successful learners, the IIT Guwahati campus visit offers an excellent opportunity to meet faculty, connect with peers, and expand your professional network. The visit’s schedule will be determined by IIT Guwahati. Please note that participation is optional, and learners will be responsible for their own travel and accommodation expenses."
  },
  {
    "id": 4,
    "question": "What are the eligibility criteria? Are there any prerequisites?",
  ...
  {
    "id": 6,
    "question": "Is there a refund policy for this Certification Program in Applied Generative AI?",
