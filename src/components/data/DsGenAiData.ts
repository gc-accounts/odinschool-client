export const DsGenAiData = [
  {
    ...
    project: [
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/AI_Content_creation_a2557e0022.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/Ai_visual_storytelling_4e3302a5d0.webp',
