export const DsGenAiIITGData = [
  {
    ...
    project: [
      {
        project_img: 'https://strapi.odinschool.com/uploads/AI_Content_creation_47b1b2b22f.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/ai_script_writer_785822ecf9.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/AI_learning_assistant_cffec69ad0.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/AI_music_generator_fbe98b54f4.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/Ai_visual_storytelling_2e5050ee85.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/Chat_AI_fdd3d98ad6.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/Q_and_A_AI_6d151be2b5.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/medical_chatbot_ffdb4eb533.webp',
      ...
      {
        project_img: 'https://strapi.odinschool.com/uploads/sql_output_c35b325442.webp',
