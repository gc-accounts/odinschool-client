...
import { CourseCertificateData } from '@/data/CourseCertificateData'
import { getDataByPage } from '@/utils/getDataByPage'
import { useEffect } from 'react'
import course from '@/utils/api/schema/course'
const CourseCertificate = () => {
    const location = useLocation()
    const currentPath = location.pathname;
    const courseCertificateData = getDataByPage(CourseCertificateData, currentPath)
