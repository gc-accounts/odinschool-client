  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const res = await fetch(`https://strapi.odinschool.com/api/master-classes?populate=*&pagination[start]=${start}&pagination[limit]=${ITEMS_PER_PAGE}`);
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {loading ? (
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex justify-between items-center pt-2">
                        ...
                        <Link href={`/masterclass/${event.slug}`} legacyBehavior>
                ...
                <p className="text-center text-gray-500 col-span-full">No masterclass available.</p>
              )}
            </div>
