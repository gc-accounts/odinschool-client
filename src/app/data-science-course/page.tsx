...
import DataScienceCourse from '@/components/pages/DataScienceCourse'; // Corrected path based on your import
...
export async function generateMetadata(): Promise<Metadata> {
  const courseSlug = 'data-science-course'; // The slug for this specific page
...
const DataScienceCoursePage = async () => {
