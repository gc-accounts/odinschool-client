          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl opacity-90 mb-8">
                Read what our students have to say about their learning experience across different platforms
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-16">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Have you completed one of our courses? We'd love to hear about your experience!
              </p>
              <a href="#" className="inline-flex items-center justify-center px-6 py-3 bg-primary text-white font-medium rounded-lg hover:bg-primary-600 transition-colors">
